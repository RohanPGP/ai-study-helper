...
function Summary({ text }) {
  return (
    <div className="card">
      <h2 style={{ fontSize: 17, fontWeight: 700, marginBottom: 14 }}>📝 Summary</h2>
...
export default function SharedStudyPack() {
      ...
      <div className="page">
        <div className="container" style={{ maxWidth: 500, textAlign: 'center' }}>
          <div className="card" style={{ padding: 48 }}>
            ...
            <h1 style={{ fontSize: 20, fontWeight: 700, marginBottom: 8 }}>Link not found</h1>
  ...
  return (
    <div className="page">
      <div className="container" style={{ maxWidth: 800 }}>
        <div className="card" style={{ marginBottom: 20, padding: '12px 18px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap' }}>
          <span style={{ fontSize: 13, color: 'var(--gray-500)' }}>👀 Shared read-only view</span>
